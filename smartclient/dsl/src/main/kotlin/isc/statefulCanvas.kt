...
@ISCDslMarker
data class StatefulCanvasProperties(
         ...
         *  @default false
         */
        var ignoreRTL: Boolean = false,
        /**
         *  Whether this widget needs to redraw to reflect state change
         *  @type {boolean}
         *  @default false
         */
        var redrawOnStateChange: Boolean = false,
        /**
         ...
         *  @default true
         */
        var showFocusedAsOver: Boolean = true,
        /**
         ...
         *  @default false
         */
        var showOverCanvas: Boolean = false,
        /**
         ...
         *  @default "{ ... }"
         */
        // var overCanvasDefaults: Canvas = definedExternally,
        /**
         ...
         */
        var editProxyConstructor: String = "StatefulCanvasEditProxy"
) : ClassProperties()