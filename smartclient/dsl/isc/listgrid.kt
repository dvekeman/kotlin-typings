...
data class ListGridProperties(
         ...
         *  @default false
         */
        var autoFetchData: Boolean = false,
        /**
         ...
         *  @default null
         */
        var initialCriteria: dynamic = null,
        /**
         ...
         *  @default null
         */
        var exportDefaultBGColor: String? = null,
        /**
         ...
         *  @default null
         */
        var exportAlternateRowBGColor: String? = null,
        /**
         *  When exporting data to Excel/OpenOffice format using ListGrid.exportData or
         ...
         *  @default false
         */
        var exportHeaderHeights: Boolean = false,
        /**
         *  When exporting data to Excel/OpenOffice format using ListGrid.exportData or
         ...
         *  @default false
         */
        var exportFieldWidths: Boolean = false,
        /**
         ...
         *  @default "0.12"
         */
        var exportWidthScale: Number = 0.12,
        /**
         *  When exporting data to Excel/OpenOffice format using ListGrid.exportData or
         ...
         *  @default false
         */
        var exportWrapHeaderTitles: Boolean = false,
        /**
         *  When exporting data to Excel/OpenOffice format using ListGrid.exportData or
         ...
         *  @default false
         */
        var exportFieldAlignments: Boolean = false,
        /**
         ...
         */
        var editProxyConstructor: String = "GridEditProxy",
        /**
         *  Default CSS class for the ListGrid as a whole.
         *  @type {CSSStyleName}
         *  @default "listGrid"
         */
        var styleName: String = "listGrid",
        /**
         ...
         *  @default "enabled"
         */
        var recordEnabledProperty: String = "enabled",
        /**
         ...
         *  @default "canExpand"
         */
        var canExpandRecordProperty: String = "canExpand",
        /**
         ...
         *  @default "_canRemove"
         */
        var recordCanRemoveProperty: String = "_canRemove",
        /**
         ...
         *  @default true
         */
        var animateFolders: Boolean = true,
        /**
         ...
         *  @default null
         */
        var animateFolderMaxRows: Number? = null,
        /**
         ...
         *  @default "100"
         */
        var animateFolderTime: Number = 100,
        /**
         ...
         *  @default "3000"
         */
        var animateFolderSpeed: Number = 3000,
        /**
         ...
         *  @default null
         */
        var defaultFields: Array<dynamic>? = null,
        /**
         ...
         *  @default true
         */
        var autoFetchDisplayMap: Boolean = true,
        /**
         ...
         *  @default true
         */
        var warnOnUnmappedValueFieldChange: Boolean = true,
        /**
         ...
         *  @default null
         */
        var saveRequestProperties: DSRequest? = null,
         ...
         *  @default null
         */
        var useRemoteValidators: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var useAllDataSourceFields: Boolean? = null,
        /**
         ...
         *  @default true
         */
        var showDetailFields: Boolean = true,
        /**
         ...
         *  @default null
         */
        var dataProperties: ResultSet? = null,
        /**
         *  When grouped, a copy of the original ungrouped data.
         *  @type {object}
         *  @default null
         */
        var originalData: dynamic = null,
        /**
         ...
         *  @default "first"
         */
        var groupStartOpen: dynamic = "first",
        /**
         ...
         *  @default true
         */
        var canCollapseGroup: Boolean = true,
        /**
         ...
         *  @default true
         */
        var collapseGroupOnRowClick: Boolean = true,
        /**
         ...
         *  @default null
         */
        var groupTitleField: String? = null,
        /**
         ...
         *  @default true
         */
        var showGroupTitleColumn: Boolean = true,
        /**
         ...
         *  @default null
         */
        var groupTitleColumnProperties: ListGridField? = null,
        /**
         ...
         *  @default "object"
         */
        //var groupTitleColumnDefaults: ListGridField = "object",
        /**
         ...
         *  @default false
         */
        var showGroupSummaryInHeader: Boolean = false,
        /**
         ...
         *  @default false
         */
        var showCollapsedGroupSummary: Boolean = false,
        /**
         ...
         *  @default "groupNode"
         */
        var groupNodeStyle: String = "groupNode",
        /**
         ...
         *  @default null
         */
        var groupNodeBaseStyle: String? = null,
        /**
         ...
         *  @default "1000"
         */
        var groupByMaxRecords: Number = 1000,
        /**
         ...
         *  @default "50"
         */
        var groupByAsyncThreshold: Number = 50,
        /**
         ...
         *  @default null
         */
        var showAsynchGroupingPrompt: Boolean? = null,
        /**
         ...
         */
        var asynchGroupingPrompt: String = "\${loadingImage}&amp;nbsp;Grouping data...",
        /**
         ...
         *  @default '-none-'
         */
        var nullGroupTitle: String = "-none-",
        /**
         ...
         *  @default "see below"
         */
        var groupByField: dynamic = "see below",
        /**
         ...
         *  @default null
         */
        var valueIconWidth: Number? = null,
        /**
         ...
         *  @default null
         */
        var valueIconHeight: Number? = null,
        /**
         ...
         */
        var hiliteIcons: Array<dynamic> = arrayOf("[SKINIMG]/Dialog/notify.png", "[SKINIMG]/Dialog/warn.png", "[SKINIMG]/actions/approve.png"),
        /**
         ...
         *  @default null
         */
        var hiliteIconWidth: Number? = null,
        /**
         ...
         *  @default null
         */
        var hiliteIconHeight: Number? = null,
        /**
         ...
         *  @default "2"
         */
        var hiliteIconLeftPadding: Number = 2,
        /**
         ...
         *  @default "2"
         */
        var hiliteIconRightPadding: Number = 2,
        /**
         ...
         *  @default null
         */
        var headerSpans: Array<dynamic>? = null,
        /**
         ...
         *  @default null
         */
        var headerSpanHeight: Number? = null,
        /**
         ...
         *  @default "center"
         */
        var headerSpanVAlign: String = "center",
        /**
         ...
         *  @default null
         */
        var unspannedHeaderVAlign: String? = null,
        /**
         ...
         *  @default null
         */
        var headerSpanConstructor: String? = null,
        /**
         ...
         *  @default null
         */
        var headerSpan: StatefulCanvas? = null,
        /**
         ...
         *  @default true
         */
        var showTreeColumnPicker: Boolean = true,
        /**
         ...
         *  @default null
         */
        var spannedHeaderBaseStyle: String? = null,
        /**
         ...
         *  @default true
         */
        var reverseRTLAlign: Boolean = true,
        /**
         ...
         *  @default false
         */
        var showAllColumns: Boolean = false,
        /**
         ...
         *  @default "250"
         */
        var drawAllMaxCells: Number = 250,
        /**
         ...
         *  @default "2.0"
         */
        var quickDrawAheadRatio: Number = 2.0,
        /**
         ...
         *  @default true
         */
        var instantScrollTrackRedraw: Boolean = true,
        /**
         ...
         *  @default "0"
         */
        var scrollRedrawDelay: Number = 0,
        /**
         ...
         *  @default "75"
         */
        var dragScrollRedrawDelay: Number = 75,
        /**
         ...
         *  @default "0"
         */
        var scrollWheelRedrawDelay: Number = 0,
        /**
         ...
         *  @default "0"
         */
        var touchScrollRedrawDelay: Number = 0,
        /**
         ...
         *  @default null
         */
        var virtualScrolling: Boolean? = null,
        /**
         ...
         *  @default "white"
         */
        var bodyBackgroundColor: String = "white",
        /**
         ...
         *  @default "20"
         */
        var minimumCellHeight: Number = 20,
        /**
         ...
         *  @default "20"
         */
        var normalCellHeight: Number = 20,
        /**
         ...
         *  @default true
         */
        var fixedRecordHeights: Boolean = true,
        /**
         ...
         *  @default false
         */
        var enforceVClipping: Boolean = false,
        /**
         ...
         *  @default true
         */
        var fixedFieldWidths: Boolean = true,
        /**
         ...
         *  @default null
         */
        var autoFitMaxHeight: Number? = null,
        /**
         *  If ListGrid.autoFitData is set to "vertical" or "both" this
         ...
         *  @default "50"
         */
        var autoFitMaxRecords: Number? = 50,
        /**
         ...
         *  @default null
         */
        var autoFitExtraRecords: Number? = null,
        /**
         ...
         *  @default null
         */
        var autoFitMaxWidth: dynamic = null,
        /**
         *  If ListGrid.autoFitData is set to "horizontal" or "both"
         ...
         *  @default "50"
         */
        var autoFitMaxColumns: Number = 50,
        /**
         ...
         *  @default true
         */
        var canAutoFitFields: Boolean = true,
        /**
         ...
         *  @default null
         */
        var autoFitFieldWidths: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var autoSizeHeaderSpans: Boolean = false,
        /**
         ...
         *  @default null
         */
        var autoFitClipFields: Array<dynamic>? = null,
        /**
         ...
         *  @default true
         */
        var autoFitFieldsFillViewport: Boolean = true,
        /**
         ...
         *  @default null
         */
        var autoFitExpandField: String? = null,
        /**
         ...
         *  @default "varies"
         */
        var defaultDateFieldWidth: Number = 60,
        /**
         ...
         *  @default "varies"
         */
        var defaultEditableDateFieldWidth: Number = 94,
        /**
         ...
         *  @default "varies"
         */
        var defaultDateTimeFieldWidth: Number = 92,
        /**
         ...
         *  @default "varies"
         */
        var defaultEditableDateTimeFieldWidth: Number = 130,
        /**
         ...
         *  @default "varies"
         */
        var defaultTimeFieldWidth: Number = 65,
        /**
         ...
         *  @default true
         */
        var leaveScrollbarGap: Boolean = true,
        /**
         ...
         *  @default null
         */
        var dateInputFormat: String? = null,
        /**
         ...
         *  @default "linkText"
         */
        var linkTextProperty: String = "linkText",
        /**
         ...
         *  @default true
         */
        var fastCellUpdates: Boolean = true,
        /**
         ...
         *  @default "cell"
         */
        var normalBaseStyle: String = "cell",
        /**
         ...
         *  @default null
         */
        var editFailedBaseStyle: String? = null,
        /**
         ...
         */
        var editFailedCSSText: String = "color:red;border:1px solid red;",
        /**
         ...
         *  @default null
         */
        var editPendingBaseStyle: String? = null,
        /**
         ...
         */
        var editPendingCSSText: String = "color:#0066CC;",
        /**
         ...
         *  @default "customStyle"
         */
        var recordCustomStyleProperty: String = "customStyle",
        /**
         ...
         *  @default "_baseStyle"
         */
        var recordBaseStyleProperty: String = "_baseStyle",
        /**
         ...
         *  @default null
         */
        var frozenBaseStyle: String? = null,
        /**
         ...
         *  @default false
         */
        var shrinkForFreeze: Boolean = false,
        /**
         ...
         *  @default false
         */
        var alternateRecordStyles: Boolean = false,
        /**
         ...
         *  @default "Dark"
         */
        var alternateRecordSuffix: String = "Dark",
        /**
         ...
         *  @default "1"
         */
        var alternateRecordFrequency: Number = 1,
        /**
         ...
         *  @default false
         */
        var alternateFieldStyles: Boolean = false,
        /**
         ...
         *  @default "AltCol"
         */
        var alternateFieldSuffix: String = "AltCol",
        /**
         ...
         *  @default "1"
         */
        var alternateFieldFrequency: Number = 1,
        /**
         ...
         *  @default null
         */
        var alternateBodyStyleName: String? = null,
        /**
         ...
         *  @default true
         */
        var includeHilitesInSummaryFields: Boolean = true,
        /**
         ...
         *  @default true
         */
        var showHilitesInGroupSummary: Boolean = true,
        /**
         ...
         *  @default true
         */
        var hiliteHTMLAfterFormat: Boolean = true,
        /**
         *  Should the "Selected" style be applied to selected records?
         *  @type {boolean}
         *  @default true
         */
        var showSelectedStyle: Boolean = true,
        /**
         ...
         *  @default true
         */
        var generateClickOnSpace: Boolean = true,
        /**
         ...
         *  @default false
         */
        var generateClickOnEnter: Boolean = false,
        /**
         *  If true, when the user navigates to a cell using arrow keys and hits Space,
         ...
         *  @default false
         */
        var generateDoubleClickOnSpace: Boolean = false,
        /**
         *  If true, when the user navigates to a cell using arrow keys and hits Enter,
         *   the cell will respond to a double click event.
         *  @type {boolean}
         *  @default true
         */
        var generateDoubleClickOnEnter: Boolean = true,
        /**
         ...
         *  @default null
         */
        var arrowKeyAction: String? = null,
        /**
         ...
         *  @default null
         */
        var hiliteRowOnFocus: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var showRecordComponents: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var showRecordComponentsByCell: Boolean? = null,
        /**
         ...
         *  @default "viewport"
         */
        var recordComponentPoolingMode:
        /**
         ...
         *  @default true
         */
        var poolComponentsPerColumn: Boolean = true,
        /**
         ...
         *  @default true
         */
        var showRollOver: Boolean = true,
        /**
         *  Are rollovers cell-level or row-level?
         *  @type {boolean}
         *  @default null
         */
        var useCellRollOvers: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var showRollOverCanvas: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var rollOverCanvas: Canvas? = null,
        /**
         ...
         *  @default null
         */
        var frozenRollOverCanvas: Canvas? = null,
        /**
         ...
         *  @default null
         */
        var showRollUnderCanvas: Boolean? = null,
        /**
         *  AutoChild created and embedded in the grid if ListGrid.showRollOver
         *   is true, and either ListGrid.showRollOverCanvas
         ...
         *  @default null
         */
        var rollUnderCanvas: Canvas? = null,
        /**
         ...
         *  @default null
         */
        var frozenRollUnderCanvas: Canvas? = null,
        /**
         ...
         *  @default false
         */
        var showSelectedRollOverCanvas: Boolean = false,
        /**
         ...
         *  @default false
         */
        var showSelectedRollUnderCanvas: Boolean = false,
        /**
         *  This setting causes the ListGrid.rollOverCanvas to be
         ...
         *  @default null
         */
        var showRollOverInExpansion: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var animateRollOver: Boolean = false,
        /**
         ...
         *  @default false
         */
        var animateRollUnder: Boolean = false,
        /**
         ...
         *  @default false
         */
        var showBackgroundComponents: Boolean = false,
        /**
         ...
         *  @default null
         */
        var backgroundComponent: Canvas? = null,
        /**
         ...
         *  @default true
         */
        var showClippedHeaderTitlesOnHover: Boolean = true,
        /**
         *  Style to apply to hovers shown over this grid.
         *  @type {CSSStyleName}
         *  @default "gridHover"
         */
        var hoverStyle: String? = "gridHover",
        /**
         ...
         *  @default null
         */
        var selection: dynamic = null,
        /**
         *  The selection associated with the ListGrid.
         *  @type {Selection | CellSelection}
         *  @default null
         */
        var selectionManager: dynamic = null,
        /**
         ...
         *  @default null
         */
        var showHeaderPartialSelection: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var canSelectGroups: Boolean = false,
        /**
         ...
         *  @default false
         */
        var showPartialSelection: Boolean = false,
        /**
         ...
         *  @default null
         */
        var selectionProperty: String? = null,
        /**
         ...
         *  @default true
         */
        var reselectOnUpdate: Boolean = true,
        /**
         ...
         */
        var reselectOnUpdateNotifications:
        /**
         ...
         *  @default "canSelect"
         */
        var recordCanSelectProperty: String = "canSelect",
        /**
         ...
         *  @default false
         */
        var canSelectCells: Boolean = false,
        /**
         ...
         *  @default true
         */
        var navigateOnTab: Boolean = true,
        /**
         ...
         *  @default true
         */
        var useCopyPasteShortcuts: Boolean = true,
        /**
         ...
         *  @default null
         */
        var originBaseStyle: String? = null,
        /**
         ...
         *  @default false
         */
        var canDragSelect: Boolean = false,
        /**
         ...
         *  @default false
         */
        var canDragSelectText: Boolean = false,
        /**
         ...
         *  @default true
         */
        var canDropInEmptyArea: Boolean = true,
        /**
         ...
         *  @default null
         */
        var showSelectionCanvas: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var selectionCanvas: Canvas? = null,
        /**
         *  If ListGrid.selectionType is set to
         *   "single",
         *
         ...
         *  @default null
         */
        var showSelectionUnderCanvas: Boolean? = null,
        /**
         *  AutoChild created and embedded in the grid if ListGrid.showSelectionCanvas
         ...
         *  @default null
         */
        var selectionUnderCanvas: Canvas? = null,
        /**
         ...
         *  @default false
         */
        var animateSelectionUnder: Boolean = false,
        /**
         ...
         *  @default null
         */
        var checkboxField: ListGridField? = null,
        /**
         ...
         *  @default null
         */
        var checkboxFieldTrueImage: String? = null,
        /**
         *  If ListGrid.selectionAppearance is set to "checkbox" this property
         ...
         *  @default null
         */
        var checkboxFieldFalseImage: String? = null,
        /**
         *  If ListGrid.selectionAppearance is set to "checkbox" this property
         ...
         *  @default null
         */
        var checkboxFieldImageWidth: Number? = null,
        /**
         *  If ListGrid.selectionAppearance is set to "checkbox" this property
         ...
         *  @default null
         */
        var checkboxFieldImageHeight: Number? = null,
        /**
         ...
         */
        var loadingDataMessage: String = "\${loadingImage}&amp;nbsp;Loading data...",
        /**
         *  The CSS style name applied to the loadingDataMessage string if displayed.
         *  @type {CSSStyleName}
         *  @default "loadingDataMessage"
         */
        var loadingDataMessageStyle: String = "loadingDataMessage",
        /**
         ...
         */
        var singleCellValueProperty: String = "singleCellValue",
        /**
         ...
         *  @default "isSeparator"
         */
        var isSeparatorProperty: String = "isSeparator",
        /**
         ...
         *  @default false
         */
        var showFilterEditor: Boolean = false,
        /**
         ...
         *  @default null
         */
        var filterEditor: RecordEditor? = null,
        /**
         ...
         *  @default null
         */
        var filterEditorProperties: RecordEditor? = null,
        /**
         ...
         *  @default null
         */
        var filterButtonProperties: Button? = null,
        /**
         *  Height for the filterEditor, if shown.
         *  @type {number}
         *  @default "22"
         */
        var filterEditorHeight: Number = 22,
        /**
         ...
         *  @default null
         */
        var allowFilterOperators: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var alwaysShowOperatorIcon: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var operatorIcon: FormItemIcon? = null,
        /**
         ...
         */
        var filterUsingText: String = "Filter using",
        /**
         ...
         *  @default "(default)"
         */
        var defaultFilterOperatorSuffix: String = "(default)",
        /**
         ...
         *  @default "_canEdit"
         */
        var recordEditProperty: String = "_canEdit",
        /**
         ...
         *  @default null
         */
        var alwaysShowEditors: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var validateByCell: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var canRemoveRecords: Boolean = false,
        /**
         ...
         *  @default false
         */
        var warnOnRemoval: Boolean = false,
        /**
         ...
         */
        var warnOnRemovalMessage: String = "Are you sure you want to delete this record?",
        /**
         ...
         */
        var removedCSSText: String = "text-decoration:line-through;",
        /**
         ...
         */
        var removeIcon: String = "[SKIN]/actions/remove.png",
        /**
         ...
         */
        var unremoveIcon: String = "[SKIN]/actions/undo.png",
        /**
         *  Default width and height of ListGrid.removeIcon for this ListGrid.
         *  @type {number}
         *  @default "16"
         */
        var removeIconSize: Number = 16,
        /**
         ...
         *  @default true
         */
        var animateRemoveRecord: Boolean = true,
        /**
         ...
         *  @default "100"
         */
        var animateRemoveTime: Number = 100,
        /**
         ...
         *  @default "200"
         */
        var animateRemoveSpeed: Number = 200,
        /**
         ...
         *  @default "{...}"
         */
        // var removeFieldDefaults: ListGridField = definedExternally,
        /**
         ...
         *  @default null
         */
        var removeFieldProperties: ListGridField? = null,
        /**
         ...
         *  @default null
         */
        var filterOnKeypress: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var stopOnErrors: Boolean = false,
        /**
         ...
         *  @default true
         */
        var autoSaveEdits: Boolean = true,
        /**
         ...
         *  @default true
         */
        var showErrorIcons: Boolean = true,
        /**
         *  Height of the error icon, if we're showing icons when validation errors occur.
         *  @type {Integer}
         *  @default "16"
         */
        var errorIconHeight: Number = 16,
        /**
         *  Height of the error icon, if we're showing icons when validation errors occur.
         *  @type {Integer}
         *  @default "16"
         */
        var errorIconWidth: Number = 16,
        /**
         ...
         */
        var errorIconSrc: String = "[SKIN]/ListGrid/validation_error_icon.png",
        /**
         ...
         *  @default false
         */
        var confirmCancelEditing: Boolean = false,
        /**
         ...
         */
        var cancelEditingConfirmationMessage: String = "Cancelling this edit will discard unsaved changes for this record. Continue?",
        /**
         ...
         *  @default true
         */
        var confirmDiscardEdits: Boolean = true,
        /**
         *  For editable listGrids, outstanding unsaved edits when the user performs a new filter
         ...
         *  @default false
         */
        var autoConfirmSaveEdits: Boolean = false,
        /**
         ...
         */
        var confirmDiscardEditsMessage: String = "This action will discard unsaved changes for this list.",
        /**
         ...
         *  @default "Save"
         */
        var discardEditsSaveButtonTitle: String = "Save",
        /**
         ...
         *  @default true
         */
        var editOnF2Keypress: Boolean = true,
        /**
         ...
         *  @default true
         */
        var enumCriteriaAsInitialValues: Boolean = true,
        /**
         ...
         *  @default "255"
         */
        var longTextEditorThreshold: Number = 255,
        /**
         ...
         *  @default null
         */
        var canTabToHeader: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var headerBarStyle: String? = null,
        /**
         ...
         *  @default "#CCCCCC"
         */
        var headerBackgroundColor: String = "#CCCCCC",
        /**
         ...
         *  @default false
         */
        var showHeaderShadow: Boolean = false,
        /**
         ...
         *  @default "1"
         */
        var headerShadowVOffset: Number = 1,
        /**
         ...
         *  @default "0"
         */
        var headerShadowHOffset: Number = 0,
        /**
         ...
         *  @default "1"
         */
        var headerShadowSoftness: Number = 1,
        /**
         ...
         *  @default null
         */
        var headerShadowColor: String? = null,
        /**
         ...
         *  @default null
         */
        var headerButtonConstructor: Class? = null,
        /**
         ...
         *  @default null
         */
        var headerBaseStyle: String? = null,
        /**
         ...
         *  @default null
         */
        var headerTitleStyle: String? = null,
        /**
         *  If this listGrid contains any frozen fields, this property can be used to apply a custom
         ...
         *  @default null
         */
        var frozenHeaderBaseStyle: String? = null,
        /**
         *  If this listGrid contains any frozen fields, this property can be used to apply a custom
         ...
         *  @default null
         */
        var frozenHeaderTitleStyle: String? = null,
        /**
         ...
         *  @default "{...}"
         */
        // var headerButtonDefaults: Button =
        /**
         ...
         *  @default null
         */
        //var headerButtonProperties: Button = definedExternally,
        /**
         ...
         *  @default null
         */
        var wrapHeaderTitles: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var wrapHeaderSpanTitles: Boolean? = null,
        /**
         ...
         *  @default "Button"
         */
        var sorterConstructor: Class = isc.Button.create(null, null),
        /**
         ...
         *  @default "corner menu"
         */
        var sorterButtonTitle: String = "corner menu",
        /**
         ...
         *  @default "{...}"
         */
        //var sorterDefaults: dynamic = definedExternally,
        /**
         ...
         *  @default null
         */
        var sorterProperties: Button? = null,
        /**
         ...
         *  @default null
         */
        var sortByGroupFirst: Boolean? = null,
        /**
         ...
         *  @default true
         */
        var sortBinaryByFileName: Boolean = true,
        /**
         ...
         *  @default true
         */
        var selectHeaderOnSort: Boolean = true,
        /**
         ...
         *  @default "7"
         */
        var sortArrowMenuButtonSpaceOffset: Number = 7,
        /**
         *  When ListGrid.leaveHeaderMenuButtonSpace is true, configures the amount of space beyond the
         *   ListGrid.headerMenuButtonWidth on the right side of a ListGrid header button (left for
         ...
         *  @default "9"
         */
        var sortNumeralMenuButtonSpaceOffset: Number = 9,
        /**
         ...
         *  @default true
         */
        var canPickFields: Boolean = true,
        /**
         ...
         *  @default false
         */
        var canPickOmittedFields: Boolean = false,
        /**
         ...
         *  @default null
         */
        var canFreezeFields: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var canAddFormulaFields: Boolean = false,
        /**
         *  Adds an item to the header context menu allowing users to launch a dialog to define a new
         ...
         *  @default false
         */
        var canAddSummaryFields: Boolean = false,
        /**
         ...
         *  @default false
         */
        var canEditHilites: Boolean = false,
        /**
         ...
         *  @default false
         */
        var showCellContextMenus: Boolean = false,
        /**
         ...
         *  @default true
         */
        var showHeaderContextMenu: Boolean = true,
        /**
         ...
         *  @default true
         */
        var showHeaderMenuButton: Boolean = true,
        /**
         ...
         *  @default null
         */
        var leaveHeaderMenuButtonSpace: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var headerMenuButtonConstructor: String? = null,
        /**
         ...
         *  @default null
         */
        var headerMenuButton: StatefulCanvas? = null,
        /**
         ...
         */
        var headerMenuButtonIcon: String = "[SKIN]/ListGrid/headerMenuButton_icon.gif",
        /**
         ...
         *  @default "7"
         */
        var headerMenuButtonIconWidth: Number = 7,
        /**
         ...
         *  @default "7"
         */
        var headerMenuButtonIconHeight: Number = 7,
        /**
         ...
         *  @default "16"
         */
        var headerMenuButtonWidth: Number = 16,
        /**
         ...
         *  @default "100%"
         */
        var headerMenuButtonHeight: dynamic = "100%",
        /**
         ...
         *  @default false
         */
        var canDragRecordsOut: Boolean = false,
        /**
         *  Indicates whether records can be dropped into this listGrid.
         *  @type {boolean}
         *  @default false
         */
        var canAcceptDroppedRecords: Boolean = false,
        /**
         ...
         *  @default false
         */
        var canReorderRecords: Boolean = false,
        /**
         ...
         *  @default true
         */
        var canReorderFields: Boolean = true,
        /**
         ...
         *  @default true
         */
        var canResizeFields: Boolean = true,
        /**
         ...
         *  @default "see below"
         */
//    var resizeFieldsInRealTime: Boolean = "see below",
        /**
         ...
         */
        var skinImgDir: String = "images/ListGrid/",
        /**
         *  Image to show when sorting ascending. See ImgProperties for format.
         *  @type {ImgProperties}
         *  @default "{...}"
         */
        // var sortAscendingImage: ImgProperties = definedExternally,
        /**
         *  Image to show when sorting descending. See ImgProperties for format.
         *  @type {ImgProperties}
         *  @default "{...}"
         */
        // var sortDescendingImage: ImgProperties = definedExternally,
        /**
         ...
         *  @default "{...}"
         */
        // var trackerImage: ImgProperties = definedExternally,
        /**
         ...
         *  @default null
         */
        var booleanBaseStyle: String? = null,
        /**
         *  If set, the ListGrid.booleanBaseStyle to use when printing.
         *  @type {CSSStyleName}
         *  @default null
         */
        var printBooleanBaseStyle: String? = null,
        /**
         ...
         *  @default null
         */
        var booleanTrueImage: String? = null,
        /**
         ...
         *  @default null
         */
        var booleanFalseImage: String? = null,
        /**
         ...
         *  @default null
         */
        var booleanPartialImage: String? = null,
        /**
         ...
         *  @default null
         */
        var printBooleanTrueImage: String? = null,
        /**
         ...
         *  @default null
         */
        var printBooleanFalseImage: String? = null,
        /**
         ...
         *  @default null
         */
        var printBooleanPartialImage: String? = null,
        /**
         ...
         *  @default "16"
         */
        var booleanImageWidth: Number = 16,
        /**
         ...
         *  @default "16"
         */
        var booleanImageHeight: Number = 16,
        /**
         *  When set to true, shows the ListGrid.dragHandleField on initial draw.
         *  @type {boolean}
         *  @default null
         */
        var showInitialDragHandles: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var dragHandleField: ListGridField? = null,
        /**
         ...
         *  @default null
         */
        var showRowNumbers: Boolean? = null,
        /**
         *  The CSS Style name for the ListGrid.rowNumberField.
         *  @type {CSSStyleName}
         *  @default "specialCol"
         */
        var rowNumberStyle: String = "specialCol",
        /**
         ...
         *  @default true
         */
        var applyRowNumberStyle: Boolean = true,
        /**
         *  The number to start the row-count from - default value is 1.
         *  @type {number}
         *  @default "1"
         */
        var rowNumberStart: Number = 1,
        /**
         ...
         *  @default null
         */
        var rowNumberField: ListGridField? = null,
        /**
         ...
         *  @default null
         */
        var exportRawValues: Boolean? = null,
        /**
         *  The method of RecordComponentPoolingMode to employ for
         ...
         *  @default "destroy"
         */
        var expansionComponentPoolingMode:
        /**
         ...
         *  @default false
         */
        var canExpandRecords: Boolean = false,
        /**
         ...
         *  @default true
         */
        var canExpandMultipleRecords: Boolean = true,
        /**
         ...
         *  @default null
         */
        var maxExpandedRecords: Number? = null,
        /**
         ...
         */
        var maxExpandedRecordsPrompt: String = "This grid is limited to \${count} simultaneously expanded records.  Please collapse some expanded records and retry.",
        /**
         ...
         *  @default null
         */
        var expansionField: ListGridField? = null,
        /**
         ...
         *  @default null
         */
        var expansionFieldTrueImage: String? = null,
        /**
         *  If ListGrid.canExpandRecords is set to true, this property
         ...
         *  @default null
         */
        var expansionFieldFalseImage: String? = null,
        /**
         ...
         *  @default false
         */
        var expansionFieldImageShowSelected: Boolean = false,
        /**
         *  If ListGrid.canExpandRecords is set to true, this property
         ...
         *  @default null
         */
        var expansionFieldImageWidth: Number? = null,
        /**
         *  If ListGrid.canExpandRecords is set to true, this property
         ...
         *  @default null
         */
        var expansionFieldImageHeight: Number? = null,
        /**
         ...
         *  @default null
         */
        var expansionDetailField: HTMLFlow? = null,
        /**
         ...
         *  @default null
         */
        var expansionDetails: DetailViewer? = null,
        /**
         ...
         *  @default null
         */
        var expansionRelated: ListGrid? = null,
        /**
         ...
         *  @default null
         */
        var expansionEditor: DynamicForm? = null,
        /**
         ...
         *  @default null
         */
        var expansionEditorShowSaveDialog: Boolean? = null,
        /**
         *  When ListGrid.canExpandRecords is true and
         ...
         */
        var expansionEditorSaveDialogPrompt: String = "You have unsaved changes - do you want to save them now?",
        /**
         ...
         *  @default true
         */
        var expansionEditorCollapseOnSave: Boolean = true,
        /**
         ...
         *  @default true
         */
        var showExpansionEditorSaveButton: Boolean = true,
        /**
         ...
         *  @default null
         */
        var expansionEditorSaveButton: IButton? = null,
        /**
         *  The title for the ListGrid.expansionEditorSaveButton.
         *  @type {string}
         *  @default "Save"
         */
        var expansionEditorSaveButtonTitle: String = "Save",
        /**
         ...
         *  @default null
         */
        var expansionDetailRelated: HLayout? = null,
        /**
         ...
         *  @default null
         */
        var expansionLayout: VLayout? = null,
        /**
         ...
         *  @default "detailDS"
         */
        var recordDetailDSProperty: String = "detailDS",
        /**
         ...
         *  @default null
         */
        var expansionCanEdit: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var filterLocalData: Boolean? = null,
        /**
         ...
         *  @default true
         */
        var discardEditsOnHideField: Boolean = true,
        /**
         ...
         *  @default "15"
         */
        var checkboxFieldHSpace: Number = 15,
        /**
         ...
         *  @default "(see below)"
         */
        //var gridComponents: Array<dynamic> = ???,
        /**
         ...
         *  @default null
         */
        var autoFitHeaderHeights: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var applyFormulaAfterSummary: Boolean = false,
        /**
         ...
         *  @default false
         */
        var allowRowSpanning: Boolean = false,
        /**
         ...
         *  @default null
         */
        var useRowSpanStyling: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var recordComponentHeight: Number? = null,
        /**
         ...
         *  @default true
         */
        var selectOnExpandRecord: Boolean = true,
        /**
         ...
         *  @default false
         */
        var selectCellTextOnClick: Boolean = false,
        /**
         ...
         *  @default true
         */
        var canFocusInEmptyGrid: Boolean = true,
        /**
         ...
         *  @default false
         */
        var showGridSummary: Boolean = false,
        /**
         ...
         */
        var includeInSummaryProperty: String = "includeInSummary",
        /**
         ...
         */
        var gridSummaryRecordProperty: String = "isGridSummary",
        /**
         ...
         */
        var groupSummaryRecordProperty: String = "isGroupSummary",
        /**
         ...
         *  @default null
         */
        var summaryRowDataSource: DataSource? = null,
        /**
         ...
         *  @default null
         */
        var summaryRowCriteria: dynamic = null,
        /**
         *  If ListGrid.showGridSummary is true, and a ListGrid.summaryRowDataSource is specified
         ...
         *  @default null
         */
        var summaryRowFetchRequestProperties: DSRequest? = null,
        /**
         ...
         */
        var recordSummaryBaseStyle: String = "recordSummaryCell",
        /**
         ...
         *  @default "20"
         */
        var summaryRowHeight: Number = 20,
        /**
         *  ListGrid.baseStyle for the ListGrid.summaryRow
         *  @type {CSSStyleName}
         *  @default "gridSummaryCell"
         */
        var summaryRowStyle: String = "gridSummaryCell",
        /**
         ...
         *  @default null
         */
        var hideEmptySummaryRow: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var allowFilterExpressions: Boolean? = null,
        /**
         ...
         *  @default "canEdit"
         */
        var canEditFieldAttribute: String = "canEdit",
        /**
         *  CSS Style to apply to the drag tracker when dragging occurs on this component.
         *  @type {CSSStyleName}
         *  @default "gridDragTracker"
         */
        var dragTrackerStyle: String = "gridDragTracker",
        /**
         ...
         *  @default "/"
         */
        var screenReaderCellSeparator: String = "/",
        /**
         *  When isc.setScreenReaderMode is enabled,
         ...
         *  @default ","
         */
        var screenReaderRowSeparator: String = ",",
        /**
         ...
         *  @default true
         */
        var showHeaderSpanTitlesInFormulaBuilder: Boolean = true,
        /**
         ...
         *  @default true
         */
        var showHeaderSpanTitlesInSortEditor: Boolean = true,
        /**
         *  If this grid has specified ListGrid.headerSpans, and
         ...
         *  @default true
         */
        var showHeaderSpanTitlesInHiliteEditor: Boolean = true,
        /**
         *  If this grid has specified ListGrid.headerSpans, and
         ...
         *  @default null
         */
        var headerHoverStyle: String? = null,
        /**
         ...
         *  @default null
         */
        var headerHoverOpacity: Number? = null,
        /**
         ...
         *  @default null
         */
        var headerHoverHeight: Number? = null,
        /**
         ...
         *  @default null
         */
        var headerHoverWidth: Number? = null,
        /**
         ...
         *  @default null
         */
        var headerHoverWrap: Boolean? = null,
        /**
         ...
         */
        var freezeOnRightText: String = "Freeze on right",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid and
         *   ListGrid.canFreezeFields is true, this string will be shown as the
         ...
         */
        var freezeOnLeftText: String = "Freeze on left",
        /**
         ...
         */
        var sortFieldAscendingText: String = "Sort Ascending",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid, this
         ...
         */
        var sortFieldDescendingText: String = "Sort Descending",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid, this
         ...
         *  @default "Clear Sort"
         */
        var clearSortFieldText: String = "Clear Sort",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid, this
         ...
         */
        var clearAllSortingText: String = "Clear All Sorting",
        /**
         ...
         */
        var clearFilterText: String = "Clear Filter",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid,
         ...
         */
        var configureSortText: String = "Configure Sort...",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid,
         ...
         */
        var configureGroupingText: String = "Configure Grouping...",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid,
         ...
         *  @default "Auto Fit"
         */
        var autoFitFieldText: String = "Auto Fit",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid,
         ...
         */
        var autoFitAllText: String = "Auto Fit All Columns",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid, and
         ...
         *  @default "Columns"
         */
        var fieldVisibilitySubmenuTitle: String = "Columns",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid and
         *   ListGrid.canFreezeFields is true, this string will be shown as the
         ...
         */
        var freezeFieldText: String = "Freeze \${title}",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid and
         *   ListGrid.canFreezeFields is true, this string will be shown as the
         ...
         */
        var unfreezeFieldText: String = "Unfreeze \${title}",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid and
         ...
         */
        var groupByText: String = "Group by \${title}",
        /**
         *  If we're showing a ListGrid.showHeaderContextMenu for this grid, and
         ...
         *  @default "Ungroup"
         */
        var ungroupText: String = "Ungroup",
        /**
         ...
         *  @default null
         */
        var multiSortDialogDefaults: MultiSortDialog? = null,
        /**
         ...
         *  @default null
         */
        var multiSortDialogProperties: MultiSortDialog? = null,
        /**
         *  When true, indicates that this ListGrid supports grouping on multiple fields.
         *  @type {boolean}
         *  @default false
         */
        var canMultiGroup: Boolean? = false,
        /**
         ...
         *  @default null
         */
        var initialSort: Array<dynamic>? = null,
        /**
         ...
         *  @default "sortNumeral"
         */
        var sortNumeralStyle: String = "sortNumeral",
        /**
         ...
         *  @default null
         */
        var showSortNumerals: Boolean? = null,
        /**
         ...
         *  @default "FacetChart"
         */
        var chartConstructor: String = "FacetChart",
        /**
         ...
         *  @default true
         */
        var showGroupTitleInFrozenBody: Boolean = true,
        /**
         ...
         *  @default false
         */
        var showGroupSummary: Boolean = false,
        /**
         ...
         *  @default null
         */
        var groupByFieldSummaries: Array<dynamic>? = null,
        /**
         ...
         *  @default "gridSummaryCell"
         */
        var groupSummaryStyle: String = "gridSummaryCell",
        /**
         ...
         *  @default null
         */
        var multiGroupDialogDefaults: MultiGroupDialog? = null,
        /**
         ...
         *  @default null
         */
        var multiGroupDialogProperties: MultiGroupDialog? = null,
        /**
         ...
         *  @default false
         */
        var useAdvancedFieldPicker: Boolean = false,
        /**
         ...
         *  @default null
         */
        var fieldPickerFieldProperties: Array<dynamic>? = null,
        /**
         ...
         *  @default null
         */
        var locateColumnsBy: String? = null,
        /**
         ...
         *  @default null
         */
        var deepCloneOnEdit: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var deepCloneNonFieldValuesOnEdit: Boolean? = null,
        /**
         ...
         *  @default false
         */
        var showHiddenFields: Boolean = false,
        /**
         ...
         *  @default null
         */
        var exportFields: Array<dynamic>? = null,
        /**
         ...
         *  @default true
         */
        var exportIncludeSummaries: Boolean = true,
        /**
         ...
         *  @default null
         */
        var preventDuplicates: Boolean? = null,
        /**
         ...
         */
        var duplicateDragMessage: String = "Duplicates not allowed",
        /**
         ...
         *  @default true
         */
        var showOfflineMessage: Boolean = true,
        /**
         ...
         */
        var offlineMessage: String = "This data not available while offline",
        /**
         ...
         */
        var offlineSaveMessage: String = "Data cannot be saved because you are not online",
        /**
         ...
         *  @default true
         */
        var addDropValues: Boolean = true,
        /**
         ...
         *  @default null
         */
        var progressiveLoading: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var useFlatFields: Boolean? = null,
        /**
         ...
         *  @default true
         */
        var canChangeNonFieldValues: Boolean = true,
        /**
         ...
         *  @default "_hilite"
         */
        var hiliteProperty: String = "_hilite",
        /**
         ...
         */
        var editHilitesText: String = "Edit Highlights",
        /**
         *  The title for the DataBoundComponent.editHilites dialog.
         *  @type {string}
         *  @default "Edit Highlights"
         */
        var editHilitesDialogTitle: String = "Edit Highlights",
        /**
         ...
         */
        var fieldEditorWindowTitle: String = "\${builderType} Editor [\${fieldTitle}]",
        /**
         *  The Window used to edit calculated fields for this component.
         *  @type {Window}
         *  @default null
         */
        var fieldEditorWindow: Window? = null,
        /**
         ...
         *  @default null
         */
        var hiliteEditor: HiliteEditor? = null,
        /**
         *  Text for a menu item allowing users to add a formula field
         *  @type {string}
         *  @default "Add formula column..."
         */
        var addFormulaFieldText: String = "Add formula column...",
        /**
         *  Text for a menu item allowing users to edit a formula field
         *  @type {string}
         *  @default "Edit formula..."
         */
        var editFormulaFieldText: String = "Edit formula...",
        /**
         *  Text for a menu item allowing users to remove a formula field
         *  @type {string}
         *  @default "Remove formula"
         */
        var removeFormulaFieldText: String = "Remove formula",
        /**
         *  Text for a menu item allowing users to add a formula field
         *  @type {string}
         *  @default "Add summary column..."
         */
        var addSummaryFieldText: String = "Add summary column...",
        /**
         *  Text for a menu item allowing users to edit the formatter for a field
         *  @type {string}
         *  @default "Edit summary format..."
         */
        var editSummaryFieldText: String = "Edit summary format...",
        /**
         *  Text for a menu item allowing users to remove a summary field
         *  @type {string}
         *  @default "Remove summary format..."
         */
        var removeSummaryFieldText: String = "Remove summary format...",
        /**
         ...
         */
        var emptyExportMessage: String = "You are attempting to export an empty dataset",
        /**
         ...
         */
        var unknownErrorMessage: String = "Invalid value",
        /**
         ...
         */
        var noErrorDetailsMessage: String = "Error during validation; no error details were provided"
) : /*DataBoundComponentProperties, */ClassProperties()
