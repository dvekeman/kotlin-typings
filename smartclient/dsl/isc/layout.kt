...
data class LayoutProperties(
         ...
         *  @default null
         */
        var members: Array<dynamic> = arrayOf(),
        /**
         ...
         *  @default null
         */
        var minBreadthMember: dynamic = null,
        /**
         ...
         *  @default true
         */
        var enforcePolicy: Boolean = true,
        /**
         ...
         *  @default null
         */
        var defaultLayoutAlign: dynamic = null,
        /**
         ...
         *  @default true
         */
        var paddingAsLayoutMargin: Boolean = true,
        /**
         ...
         *  @default null
         */
        var layoutLeftMargin: Number? = null,
        /**
         ...
         *  @default null
         */
        var layoutRightMargin: Number? = null,
        /**
         ...
         *  @default null
         */
        var layoutTopMargin: Number? = null,
        /**
         ...
         *  @default null
         */
        var layoutBottomMargin: Number? = null,
        /**
         ...
         *  @default false
         */
        var leaveScrollbarGap: Boolean = false,
        /**
         ...
         *  @default "see below"
         */
        // var resizeBar: Splitbar = definedExternally,
        /**
         ...
         *  @default "Splitbar"
         */
        var resizeBarClass: String = "Splitbar",
        /**
         *  Thickness of the resizeBar in pixels.
         *  @type {Integer}
         *  @default "7"
         */
        var resizeBarSize: Number = 7,
        /**
         ...
         *  @default null
         */
        var animateMembers: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var animateMemberTime: Number? = null,
        /**
         ...
         *  @default true
         */
        var canDropComponents: Boolean = true,
        /**
         ...
         *  @default "2"
         */
        var dropLineThickness: Number = 2,
        /**
         ...
         *  @default null
         */
        var showDropLines: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var showDragPlaceHolder: Boolean? = null,
        /**
         ...
         *  @default null
         */
        var placeHolderProperties: Canvas? = null,
        /**
         ...
         *  @default true
         */
        var managePercentBreadth: Boolean = true,
        /**
         *  If Layout.showDragPlaceHolder is true, this
         ...
         *  @default null
         */
        var placeHolderDefaults: Canvas? = null,
        /**
         ...
         */
        var editProxyConstructor: String = "LayoutEditProxy"
)
